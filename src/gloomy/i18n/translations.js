export const translations = {
  en: {
    ...
    nav: {
      brand: "Gloomy Studios",
      logoAlt: "Gloomy Studios logo",
      items: {
        home: "Home",
        websites: "Websites",
        design: "Design",
    ...
    footer: {
      headline: "Ready to elevate your brand online?",
      cta: "Let’s talk",
      addressLine1: "1940 El Cajon Blvd, San Diego,",
      addressLine2: "CA 92104, United States",
    ...
    pages: {
      about: {
        title: "About",
        description:
          "We build brands and digital experiences with a strong visual identity and a practical product mindset.",
      },
      contact: {
        title: "Contact",
        description:
          "Tell us what you are building and we can define the right direction for your site, brand, or campaign.",
      },
      design: {
        title: "Design",
        description:
          "Interface, visual, and brand design work focused on clarity, personality, and conversion.",
      },
      ourWork: {
        title: "Our Work",
        description:
          "A selection of website, branding, and digital product work built to move businesses forward.",
      },
      services: {
        title: "Services",
        description:
      ...
      websites: {
        title: "Websites",
        description:
          "We create websites that feel sharp, perform well, and support real business goals.",
      },
    },
  },
  es: {
    ...
    nav: {
      brand: "Gloomy Studios",
      logoAlt: "Logo de Gloomy Studios",
      items: {
        home: "Inicio",
        websites: "Sitios web",
        design: "Diseño",
...
brandingLanding: {
    ...
    footer: {
      headline: "¿Listo para elevar tu marca en internet?",
      cta: "Hablemos",
      addressLine1: "1940 El Cajon Blvd, San Diego,",
      addressLine2: "CA 92104, Estados Unidos",
    ...
    pages: {
      about: {
        title: "Nosotros",
        description:
          "Construimos marcas y experiencias digitales con una identidad visual fuerte y una mentalidad práctica de producto.",
      },
      contact: {
        title: "Contacto",
        description:
          "Cuéntanos qué estás construyendo y definimos la dirección correcta para tu sitio, marca o campaña.",
      },
      design: {
        title: "Diseño",
        description:
          "Trabajo de interfaz, diseño visual y branding enfocado en claridad, personalidad y conversión.",
      },
      ourWork: {
        title: "Nuestro trabajo",
        description:
          "Una selección de proyectos de sitios web, branding y producto digital pensados para hacer avanzar negocios.",
      },
      services: {
        title: "Servicios",
        description:
      ...
      websites: {
        title: "Sitios web",
        description:
          "Creamos sitios web con carácter, buen rendimiento y objetivos de negocio claros.",
      },
    },
  },
};
